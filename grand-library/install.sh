...
mkdir -p "$TARGET/.claude/commands/grand-library"
...
# Copy command files
cp "$SCRIPT_DIR/commands/"*.md "$TARGET/.claude/commands/grand-library/"

echo ""
echo "Done! Grand Library is installed."
echo ""
echo "  Skill:    $TARGET/.claude/skills/grand-library/"
echo "  Commands: $TARGET/.claude/commands/grand-library/"
echo ""
